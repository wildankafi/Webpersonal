...
class __TwigTemplate_e32bd0f6ad67fffb588cf1bec0350fdcd8e4ecb9d8d53a0bec5dd02010345c46 extends Twig_Template
{
    ...
    ";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["crumb"]) {
                ...
                if ( !$this->getAttribute($context["loop"], "last", array())) {
                    ...
                    echo "\" class=\"pure-button\" itemprop=\"url\"><span itemprop=\"title\">";
        ...
        ";
            ...
            ";
                        ...
                        // line 18
                        echo "                <a href='#' class=\"pure-button pure-button-primary\"><span itemprop=\"title\">";
                        echo $this->getAttribute($context["crumb"], "menu", array());
                        echo "</span></a>
            ";
                    }
...
/*     {% for crumb in crumbs %}*/
/*         {% if not loop.last %}*/
/*             <a href="{{ crumb.url }}" class="pure-button" itemprop="url"><span itemprop="title">{{ crumb.menu }}</span></a>*/
/*             <i class="{{ divider }}"></i>*/
/*         {% else %}*/
/*             {% if breadcrumbs_config.link_trailing %}*/
/*                 <a href="{{ crumb.url }}" class="pure-button" itemprop="url"><span itemprop="title">{{ crumb.menu }}</span></a>*/
/*             {% else %}*/
/*                 <a href='#' class="pure-button pure-button-primary"><span itemprop="title">{{ crumb.menu }}</span></a>*/
/*             {% endif %}*/
/*         {% endif %}*/
/*     {% endfor %}*/
/* </div>*/
