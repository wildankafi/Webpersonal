...
<!-- Title -->
<title>Wildan Mukafi - Web and Mobile Developer</title>
...
<div id="content" class="bg-white">
    ...
    <section id="start" class="section fullheight bg-secondary dark padding-v-60">
        ...
        <div class="bg-slideshow">
            <div class="bg-image animated infinite zooming"><img src="assets/img/bg.jpg" alt="..."></div>
        </div>
        
        <!-- Middle -->
        <div class="container container-wide v-bottom padding-v-80">
            <img src="assets/img/me.jpg" alt="..." class="img-circle margin-b-30">
            <h1 class="text-lg margin-b-0">Hi! I’m <strong>Wildan Mukafi</strong></h1>
            <h5 class="text-tertiary margin-b-40">Web and Mobile Developer</h5>
            ...
            <div class="row padding-lg">
                <div class="col-md-4 col-sm-6 col-xs-12">
                    ...
                    <div class="resume-box">
                        ...
                        <p class="lead">saya juga bingung bagian about me ini mau di isi apa . Yaudah saya  perkenalkan diri saja, Nama saya wildan mukafi lebih lengkapnya ahmad wildan mukafi biasa di pangging dengan wildan atau mukafi. saya sekarang masih kuliah s1 informatika di universitas brawijaya. asli saya dari kota marmer Tulungagung, bukan  kota sih.. tp lebih tepatnya Kabupaten, kabupaten kecil yang ada di propinsi jawa timur ya katanya banyak pantainya, tp jangan tanya saya di mana letak pantainya, karena saya tidak pernah keluar rumah saya anak rumahan :v wkwkwk.. ok sekian dan aura kasih</p>  
                    </div>
                ...
                <div class="col-md-4 col-sm-6 col-xs-12">
                    ...
                    <div class="resume-box">
                        ...
                        <!-- Speciality -->
                        <div class="speciality">
                            <span class="speciality-icon"><i class="text-muted-2x ti-layout"></i></span>
                            <div class="speciality-content">
                        ...
                        <div class="speciality">
                            ...
                            <div class="speciality-content">
                                <h5 class="margin-b-0">Mobile App</h5>
                                <p class="speciaity-description">Great, modern App designes.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="resume-box">
                        ...
                        <div class="timeline">
                            ...
                            <div class="timeline-event te-primary">
                                <span class="event-date">Jan 2007 - Dec 2010</span>
                                <span class="event-name">SMP</span>
                                <span class="event-description">MTs N Tulungagung</span>
                            </div>
                            <!-- Single event -->
                            <div class="timeline-event te-primary">
                                <span class="event-date">Jan 2010 - Dec 2013</span>
                                <span class="event-name">SMA</span>
                                <span class="event-description">MAN 2 Tulungagung</span>
                            </div>
                            <!-- Single event -->
                            <div class="timeline-event te-primary">
                                <span class="event-date">Jan 2013 </span>
                                <span class="event-name">Sarjana</span>
                                <span class="event-description">Universitas Brawijaya</span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-4 col-sm-6 col-xs-12">
                    ...
                    <!-- Resume Box / Hobbies -->
                    <div class="resume-box">
                        <span class="icon animated" data-animation="fadeInDown"><i class="ti-game text-tertiary"></i></span>
                        <h4><strong>Hobbies</strong> &amp; Interests</h4>
                            <ul class="list-inline">
                            <li>
                                <div class="icon-box text-center">
                                    <span class="icon icon-sm icon-circle icon-primary icon-filled"><i class="ti-basketball"></i></span>
                                    <span class="title">Olahraga</span>
                                </div> 
                            </li> 
                            <li>
                                <div class="icon-box text-center">
        ...
        <div class="container container-wide">
            ...
            <div id="portfolio-list" class="row masonry">
                ...
                <div class="webdesign masonry-item margin-b-30 col-lg-3 col-sm-6 col-xs-12">
                    <div class="gallery-item">
                        <div class="item-photo">
                            <a href="#" data-target="ajax-modal"><img src="assets/img/porto/bli.png" alt="" /></a>
                            <div class="item-hover bg-dark dark">
                                <div class="item-hover-content">
                                    <a href="#" data-target="ajax-modal" class="icon icon-sm icon-hover icon-circle icon-primary"><i class="fa fa-link"></i></a>
                                    <a href="#" target="_blank" class="icon icon-sm icon-circle icon-white icon-hover"><i class="fa fa-play"></i></a>
                ...
                <div class="development masonry-item margin-b-30 col-lg-6 col-sm-12 col-xs-12">
                    <div class="gallery-item">
                        <div class="item-photo">
                            <a href="#" data-target="ajax-modal"><img src="assets/img/porto/hama.png" alt="" /></a>
                            <div class="item-hover bg-dark dark">
                                <div class="item-hover-content">
                                    <a href="#" data-target="ajax-modal" class="icon icon-sm icon-hover icon-circle icon-primary"><i class="fa fa-link"></i></a>
                                    <a href="#" target="_blank" class="icon icon-sm icon-circle icon-white icon-hover"><i class="fa fa-play"></i></a>
    ...
    <section id="posts" class="section bg-primary dark padding-v-60">
        <!-- Content -->
        <div class="container container-wide">
                ...
                <article class="post post-item masonry-item col-lg-4 col-sm-6 col-xs-12">
                    <div class="post-content animated" data-animation="fadeInUp">
                        <div class="meta">
                            ...
                            <span><i class="fa fa-user"></i><a href="#">wildankafi</a></span>
                            <span><i class="fa fa-tag"></i><a href="#">Webdevelopment</a></span>
                        </div>
                        <div class="date">28 July, 2016</div>
                        <h1><a href="http://localhost/wildankafi/blog/blog/posting-pertama-3">Cara Membuat Website Sederhana dengan HTML 5</a></h1>
                        <p class="lead">Pada kesempatan kali ini kita akan membahas cara membuat website sederhana dengan html 5,</p>
                        <p>Per ea tibique fabellas electram. Ea aliquam corpora vis. Ne quot civibus atomorum quo. </p>
                        <a href="http://localhost/wildankafi/blog/blog/posting-pertama-3" class="btn btn-primary btn-xs"><span>Read more</span><i class="ti-arrow-right"></i></a>
                    </div>
                </article>
                <!-- Masonry Element / Post -->
                <article class="post post-item masonry-item col-lg-4 col-sm-6 col-xs-12">
                    <div class="post-content animated" data-animation="fadeInUp">
                        <div class="meta">
                            <span><i class="fa fa-comment"></i><a href="#">4</a></span>
                            <span><i class="fa fa-user"></i><a href="#">Wildan Mukafi</a></span>
                            <span><i class="fa fa-tag"></i><a href="#">Webdesign</a></span>
                        </div>
                        <div class="date">28 July, 2016</div>
                        <h1><a href="http://localhost/wildankafi/blog/blog/posting-pertama">Cara Mempercepat Loading Website Blog Lengkap</a></h1>
                        <p class="lead">Trik cara mempercepat loading website blog harus diterapkan pada semua web</p>
                        <p>PKarena semua pasti setuju jika semua pengunjung menyukai web yang cepat saat loading konten-nya. Memang benar jika loading website berhubungan dengan kecepatan internet anda, yang perlu di ketahui bahwa tidak selalu benar jika semakin cepat koneksi anda maka akan semakin cepat loading web. </p>
                        <a href="http://localhost/wildankafi/blog/blog/posting-pertama" class="btn btn-primary btn-xs"><span>Read more</span><i class="ti-arrow-right"></i></a>
                    </div>
                </article>
                <!-- Masonry Element / Post -->
                <article class="post post-item masonry-item col-lg-4 col-sm-6 col-xs-12">
                    <div class="post-content animated" data-animation="fadeInUp">
                        ...
                        <h1><a href="http://localhost/wildankafi/blog/blog/posting-pertama-2">Cara Memasang dan Menggunakan Font Awesome</a></h1>
                        <p class="lead">Dalam tutorial cara memasang dan menggunakan font awesome</p>
                        <p>kita akan mencoba untuk mengenal, memasang dan menggunakan font ini dalam template kita. Banyak para pengembang web yang menggunakan font ini kedalam proyek mereka, dan sekarang (mei 2015) font ini sudah di versi 4.3.0 dengan 519 total ikon. Apa saja keuntungan dan cara memasangnya?</p>
    ...
    <section id="contact" class="section padding-v-60 min-fullheight">
        ...
        <div class="contact-box bg-secondary dark animated" data-animation="flipInY">
            ...
            <ul class="list-unstyled list-unstyled-icons">
                ...
                <li><i class="inline-icon icon-before-and-after text-primary fa fa-comment"></i><a href="#">Wildan@mail.com</a></li>
                <li><i class="inline-icon icon-before-and-after text-primary fa fa-phone"></i>+0(62)85 736816570</li>
            </ul>
